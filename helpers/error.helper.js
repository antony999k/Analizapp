...
exports.movedPermanently = (err, req, res) => {
    res.status(301).send({
        ...
        customMessage: '(Analizapp) Moved Permanently' + (err.message ? ': ' + err.message : ': '),
...
exports.seeOther = (err, req, res) => {
    res.status(303).send({
        status: 303,
        name: 'seeOther',
        customMessage: '(Analizapp) See Other' + (err.message ? ': ' + err.message : ': '),
...
exports.notModified = (err, req, res) => {
    res.status(304).send({
        status: 304,
        name: 'notModified',
        customMessage: '(Analizapp) Not Modified' + (err.message ? ': ' + err.message : ''),
...
exports.temporaryRedirect = (err, req, res) => {
    res.status(307).send({
        ...
        customMessage: '(Analizapp) Temporary Redirect' + (err.message ? ': ' + err.message : ''),
...
exports.permanentRedirect = (err, req, res) => {
    res.status(308).send({
        ...
        customMessage: '(Analizapp) Permanent Redirect' + (err.message ? ': ' + err.message : ''),
...
exports.badRequest = (err, req, res) => {
    res.status(400).send({
        status: 400,
        name: 'badRequest',
        customMessage: '(Analizapp) Bad Request' + (err.message ? ': ' + err.message : ''),
...
exports.unautorized = (err, req, res) => {
    res.status(401).send({
        status: 401,
        name: 'unautorized',
        customMessage: '(Analizapp) Unautorized' + (err.message ? ': ' + err.message : ''),
...
exports.forbidden = (err, req, res) => {
    res.status(403).send({
        status: 403,
        name: 'Forbidden',
        customMessage: '(Analizapp) Forbidden' + (err.message ? ': ' + err.message : ''),
...
exports.notFound = (err, req, res) => {
    res.status(404).send({
        status: 404,
        name: 'notFound',
        customMessage: '(Analizapp) Not Found' + (err.message ? ': ' + err.message : ''),
...
exports.conflict = (err, req, res) => {
    res.status(409).send({
        status: 409,
        name: 'Conflict',
        customMessage: '(Analizapp) Conflict' + (err.message ? ': ' + err.message : ''),
...
exports.unsupportedMediaType = (err, req, res) => {
    res.status(415).send({
        ...
        customMessage: '(Analizapp) Unsupported Media Type' + (err.message ? ': ' + err.message : ''),
...
exports.imATeapot = (err, req, res) => {
    res.status(418).send({
        status: 418,
        name: 'imATeapot',
        customMessage: '(Analizapp) I am a teapot' + (err.message ? ': ' + err.message : ''),
...
exports.internal = (err, req, res) => {
    res.status(500).send({
        ...
        customMessage: '(Analizapp) Internal Server Error' + (err.message ? ': ' + err.message : ''),
...
exports.notImplemented = (err, req, res) => {
    res.status(501).send({
        status: 501,
        name: 'notImplemented',
        customMessage: '(Analizapp) Not Implemented' + (err.message ? ': ' + err.message : ''),
...
exports.badGateway = (err, req, res) => {
    res.status(502).send({
        status: 502,
        name: 'badGateway',
        customMessage: '(Analizapp) Bad Gateway' + (err.message ? ': ' + err.message : ''),
...
exports.serviceUnavailable = (err, req, res) => {
    res.status(503).send({
        ...
        customMessage: '(Analizapp) Service Unavailable' + (err.message ? ': ' + err.message : ''),
...
exports.gatewayTimeout = (err, req, res) => {
    res.status(504).send({
        status: 504,
        name: 'serviceUnavailable',
        customMessage: '(Analizapp) Gateway Timeout' + (err.message ? ': ' + err.message : ''),
...
exports.insufficientStorage = (err, req, res) => {
    res.status(507).send({
        ...
        customMessage: '(Analizapp) Insufficient Storage' + (err.message ? ': ' + err.message : ''),
